        ...
        <div className={`columns`}>
            ...
            <div className={`${utilStyles.content} column`}>
                ...
                <ul className={styles.description}>
                    ...
                    <ul><span className={styles.attribute}>Occupation</span>: Full-Stack Developer (specializing in Salesforce B2C Commerce/Salesforce Commerce Cloud)</ul>
                    <ul><span className={styles.attribute}>Interests</span>: traveling, miniature schnauzers, museums, taking photos of creepy things, miniature houses</ul>
                </ul>
            </div>
        </div>
    )
